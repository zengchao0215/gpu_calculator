...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-2xl glass-card p-1 text-muted-foreground gap-1",
      className
    )}
    {...props}
  />
